...
interface ToolHistoryV2DaoNorthMacedonia {
    ...
    @Upsert
    suspend fun insertData(data: V2HistoryTagResponseNorthMacedonia)
    ...
    fun fetchPassageBySerial(serial: String,countryCode: String): V2HistoryTagResponseNorthMacedonia?
