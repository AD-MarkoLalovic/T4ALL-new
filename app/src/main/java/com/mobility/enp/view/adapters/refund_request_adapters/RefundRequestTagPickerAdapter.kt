...
class RefundRequestTagPickerAdapter(
    ...
    private val differ = AsyncListDiffer(this, object : DiffUtil.ItemCallback<TagsRefundRequestUIModel>() {
        override fun areItemsTheSame(oldItem: TagsRefundRequestUIModel, newItem: TagsRefundRequestUIModel): Boolean {
            return oldItem.serialNumber == newItem.serialNumber // Ili druga jedinstvena identifikacija
        }

        override fun areContentsTheSame(oldItem: TagsRefundRequestUIModel, newItem: TagsRefundRequestUIModel): Boolean {
